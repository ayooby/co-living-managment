...
[![Build Status](https://travis-ci.org/ayooby/piedpiper-web.svg?branch=master)](https://travis-ci.org/ayooby/piedpiper-web)
[![Built with](https://img.shields.io/badge/Built_with-Cookiecutter_Django_Rest-F7B633.svg)](https://github.com/agconti/cookiecutter-django-rest)

manage co-living aparatment. Check out the project's [documentation](http://ayooby.github.io/piedpiper-web/).
